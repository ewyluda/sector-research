"""Unittest for parse_structured_output + PositionMonitorOutput.

Converted from backend/scripts/verify_position_parser.py (2026-06-10).
"""
...
class TestPositionParser(unittest.TestCase):
    ...
    def test_minimum_lists(self) -> None:
    ...
    def test_too_few_monitoring(self) -> None:
    ...
    def test_position_size_out_of_range(self) -> None:
    ...
    def test_empty_add_triggers(self) -> None:
